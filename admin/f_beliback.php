    ...
    <!-- Form nota-->
      ...
      <div id="fnotabeli" class="w3-modal hrf_arial" style="padding-top:50px;background-color:rgba(1, 1, 1, 0.3);border-style: ridge; ">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:700px;border-radius:5px;box-shadow: 0px 2px 60px;border-style: ridge;border-color:white;background: linear-gradient(180deg, #FAFAD2 10%, white 90%)">
          ...
          <div class="w3-center">
            <span onclick="html5QrcodeScanner.clear();lastResult=0;document.getElementById('fnotabeli').style.display='none';" class="w3-display-topright" title="Close Modal" style="margin-top: -3px;margin-right: 0px"><img style="width: 108%" src="img/tomexit2.png" alt=""></span>    
          </div>
            ...
            <div class="w3-container w3-card" style="border-style: ridge;border-color: white;">
              ...
              <div id="boxdtbrg" class="w3-row">
                <div class="w3-col l12" >
                  ...
                  <div class="form-group row hrf_arial" style="margin-top: -11px">
                    <label for="kd_brg" class="col-sm-3 col-form-label"><b>ID. Barang</b></label>
                    <div class="col-sm-9">
                      <div class="input-group">
                        <input class="form-control hrf_arial" onkeyup="cariidbrg2(1, true);" id="kd_brg" type="text" name="kd_brg" style="border: 1px solid black; " placeholder="ketik id. barang" required="" tabindex="5">
                        <span><button id="btn-idbrg" class="form-control yz-theme-l4 w3-hover-shadow hrf_arial" style="cursor: pointer;border:1px solid black" type="button"><i class="fa fa-caret-down"></i></button></span>
                      </div>
                  ...
                  <div class="form-group row" style="margin-top: -11px">
                    ...
                    <div class="col-sm-9" >
                      <div class="input-group">
                        <input id="nm_brg" type="text" style="border: 1px solid black; " class="form-control hrf_arial" onkeyup="carinmbrg2(1,true)" name="nm_brg" required="" tabindex="6" placeholder="ketik nama barang">
                  ...
                  <div class="form-group row" style="margin-top: -12px">
                    ...
                    <div class="col-sm-9" style="margin-bottom: 0px">
                      <div class="input-group">
                        ...
                        <input id="nm_bag" type="text" style="border: 1px solid black; " class="form-control hrf_arial" onkeyup="carinmbag(1,true)" name="nm_bag" required="" tabindex="7" placeholder="ketik bagian penjualan">
                        <span><button id="btn-nmbag" class="form-control yz-theme-l4 w3-hover-shadow" style="cursor: pointer;border:1px solid black" type="button"><i class="fa fa-caret-down"></i></button></span>
                      </div>
                ...
                <div class="form-group row" style="margin-top: -12px">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group">
                      ...
                      <span><button id="btn-nmsat" class="hrf_res form-control yz-theme-l4 w3-hover-shadow" style="cursor: pointer;border:1px solid black" type="button"><i class="fa fa-caret-down"></i></button></span>
                    </div>
