              ...
              <div id="boxdtbrg" class="w3-row">
                <div class="w3-col l12" >
                  ...
                  <div class="form-group row hrf_arial" style="margin-top: -11px">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group">
                        <input class="form-control hrf_arial" onkeyup="cariidbrg2(1, true);" id="kd_brg" type="text" name="kd_brg" style="border: 1px solid black;" placeholder="ketik id. barang"  tabindex="5">
