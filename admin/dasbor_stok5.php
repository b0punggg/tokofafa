...
<div style="overflow:auto;">
    ...
    <?php
		...
		if(isset($_POST['search']) && $_POST['search'] == true){ // Jika ada data search yg 
	      $sql =mysqli_query($constok, "SELECT SUM(beli_brg.stok_jual) AS stok_juals, beli_brg.kd_brg,beli_brg.kd_toko,beli_brg.jml_brg,mas_brg.nm_brg,mas_brg.kd_kem1,mas_brg.jum_kem1,mas_brg.hrg_jum1,mas_brg.kd_kem2,mas_brg.jum_kem2,mas_brg.hrg_jum2,mas_brg.kd_kem3,mas_brg.jum_kem3,mas_brg.hrg_jum3,mas_brg.nm_kem1,mas_brg.nm_kem2,mas_brg.nm_kem3,mas_brg.brg_msk,mas_brg.brg_klr FROM beli_brg
	    	...
	    	HAVING stok_juals>0 AND stok_juals<=5
		  ...
		  $sql2=mysqli_query($constok,"SELECT count(*) AS jumlah FROM (SELECT COUNT(*) FROM beli_brg 
		  	WHERE beli_brg.kd_toko='$kd_toko' GROUP BY kd_brg,kd_toko HAVING sum(stok_jual)>0 AND sum(stok_jual)<=5 ) jumlah"); 
  ...
  <nav  aria-label="Page navigation example" style="font-size: 9pt">
      <ul class="pagination justify-content-center">
        ...
        ?>
          <li><a class="page-link yz-theme-d1" style="cursor: pointer" href="javascript:void(0);" onclick="caristok5(1, false)">First</a></li>
          <li><a class="page-link yz-theme-l1" style="cursor: pointer" href="javascript:void(0);" onclick="caristok5(<?php echo $link_prev; ?>, false)">&laquo;</a></li>
        <?php
        }
        ?>
        ...
        ?>
          <li class="page-item " <?php echo $link_active; ?>><a class="page-link  yz-theme-l3" href="javascript:void(0);" style="cursor: pointer" onclick="caristok5(<?php echo $i; ?>, false)"><?php echo $i; ?></a></li>
        <?php
        }
        ?>
        ...
        ?>
          <li class="page-item"><a class="page-link yz-theme-l1" href="javascript:void(0)" onclick="caristok5(<?php echo $link_next; ?>, false)" style="cursor: pointer">&raquo;</a></li>
          <li class="page-item "><a class="page-link yz-theme-d1" href="javascript:void(0)" onclick="caristok5(<?php echo $jumlah_page; ?>, false)" style="cursor: pointer">Last</a></li>
        <?php
        }
        ?>
      </ul>
