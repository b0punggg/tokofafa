...
<?php 
  ...
  if(!empty($pesan1) || !empty($pesan2) || !empty($pesan3) || !empty($pesan4) || !empty($ada_kd_brg3) || !empty($ada_nm_brg3) || !empty($pesan6) || !empty($pesan7) || !empty($pesan8) ){
    ...
    if(!empty($ada_kd_brg1) || !empty($ada_nm_brg1) || !empty($ada_kd_bar1)){
      ?> <script>document.getElementById('fmascek2').style.display='block';</script><?php
    }else{ ?>
      <script>document.getElementById('simpanok').click();</script> <?php
    } ?>
...
<!-- Form CEK-->
<div id="fmascek2" class="w3-modal w3-center" style="padding-top:50px;background-color:rgba(1, 1, 1, 0.6);border-style: ridge; ">
  <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:390px;border-radius:5px;box-shadow: 0px 2px 60px;border-style: ridge;border-color:white">
    ...
    <div class="w3-center">
      <span onclick="document.getElementById('fmascek2').style.display='none'" class="w3-display-topright" title="Close Modal" style="margin-top: -3px;margin-right: 0px;cursor:pointer"><img style="width: 108%" src="img/tomexit2.png" alt=""></span>    
    </div>
  
    <div class="modal-body w3-center">   
      <div class="hrf_rale" style="font-size:12pt">Simpan Perubahan Data ?</div>
      <div class="row mt-3">
        <div class="col-sm-8 offset-2">
          <button class="btn btn-sm btn-outline-success" type="button" onclick=";document.getElementById('simpanok').click();" style="width:100px;"><i class="fa fa-save"></i>&nbsp;Simpan</button>
          <button class="btn btn-sm btn-outline-secondary" type="button" onclick="document.getElementById('fmascek2').style.display='none';document.getElementById('tmb-reset').click()" style="width:100px;"><i class="fa fa-undo"></i>&nbsp;Tidak</button>
        </div>
      </div>
    </div>
  </div>    
