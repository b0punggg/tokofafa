...
<body class="F4 ">      
  <section class="sheet padding-10mm">  
    <div style="page-break-before: always;">
        ...
        unset($cektoko,$sql); 
        if ($pilihan=='alldata'){
            $cek=mysqli_query($connect,"SELECT mas_jual_hutang.*,pelanggan.nm_pel,pelanggan.al_pel FROM mas_jual_hutang 
              LEFT JOIN pelanggan ON mas_jual_hutang.kd_pel=pelanggan.kd_pel
              WHERE MONTH(mas_jual_hutang.tgl_tran)='$endbln' AND YEAR(mas_jual_hutang.tgl_tran)='$endyear' AND byr_hutang>0
              ORDER BY mas_jual_hutang.tgl_tran,mas_jual_hutang.no_fakjual ASC");   
          
        }else {
          $toko=$_POST['kd_tokomutpiut'];
          $cek=mysqli_query($connect,"SELECT mas_jual_hutang.*,pelanggan.nm_pel,pelanggan.al_pel FROM mas_jual_hutang 
              LEFT JOIN pelanggan ON mas_jual_hutang.kd_pel=pelanggan.kd_pel
              WHERE MONTH(mas_jual_hutang.tgl_tran)='$endbln' AND YEAR(mas_jual_hutang.tgl_tran)='$endyear' AND byr_hutang>0 AND kd_toko='$toko'
              ORDER BY mas_jual_hutang.tgl_tran,mas_jual_hutang.no_fakjual ASC");   
        }
          if(mysqli_num_rows($cek)>=1){
            ?>
              ...
              <thead>
                ...
                <tr> <td colspan="10" style="text-align: left;font-size: 10pt"><b>Laporan Pembayaran Piutang Pelanggan Bulan Berjalan
                </b></td></tr>
               <tr style="background-color: lightgrey;">
                ...
                <tr>
    	            ...
    	            <td style="text-align:center;font-size: 8pt"><?php echo $databay['no_fakjual'];?></td>
