...
<div class="table-responsive" style="overflow-y:auto;overflow-x: auto;border-style: ridge;">
	  <table class="arrow-nav2 table-bordered table-striped table-hover hrf_res" style="width: 100%">
	    ...
	    ?>
	      ...
	      <tr>
	        <td align="left" style="cursor: pointer" onclick="document.getElementById('<?='btnnmbag'.$no?>').click();"><input class="w3-input" type="text" tabindex="7" style="border: none;background-color: transparent;cursor: pointer" readonly value="<?=$databrg['nm_bag']; ?>" onkeydown="if(event.keyCode==13){document.getElementById('<?='btnnmbrg'.$no?>').click()}"></td>
	        <td>
