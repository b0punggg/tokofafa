                ...
                <div class="form-group row w3-margin-top">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group">
                      <input class="form-control hrf_arial" onkeyup="cariidbrg(1, true);" onkeypress="return event.keyCode != 13;" id="kd_brg" type="text" name="kd_brg" style="border: 1px solid black;" placeholder="ketik kode barang" tabindex="2"> 
