      ...
      if ($params=="") {	 
        ...
        if(!empty($kd_brg)){
          ...
          $sql =mysqli_query($connect, "SELECT beli_brg.ket, beli_brg.tgl_fak,beli_brg.no_urut,beli_brg.kd_brg,beli_brg.jml_brg,beli_brg.kd_bar,beli_brg.kd_toko,beli_brg.no_fak,beli_brg.tgl_fak,beli_brg.kd_sup,beli_brg.kd_sat,beli_brg.hrg_beli,beli_brg.disc1,beli_brg.disc2,beli_brg.ppn,kemas.nm_sat1,kemas.nm_sat2,supplier.nm_sup,mas_brg.nm_brg,mas_brg.kd_kem1,mas_brg.jum_kem1,mas_brg.hrg_jum1,mas_brg.kd_kem2,mas_brg.jum_kem2,mas_brg.hrg_jum2,mas_brg.kd_kem3,mas_brg.jum_kem3,mas_brg.hrg_jum3,beli_brg.id_bag,bag_brg.nm_bag
              ...
              WHERE beli_brg.kd_toko='$kd_toko' AND beli_brg.no_fak='$no_fak' AND beli_brg.tgl_fak='$tgl_fak' AND mas_brg.nm_brg like '$kd_brg' AND INSTR(beli_brg.ket,'MUTASI')=0 AND INSTR(beli_brg.ket,'RETUR')=0 ORDER BY mas_brg.nm_brg ASC LIMIT $limit_start, $limit");
            $sql2 = mysqli_query($connect, "SELECT COUNT(*) AS jumlah FROM beli_brg 
              LEFT JOIN mas_brg ON beli_brg.kd_brg=mas_brg.kd_brg 
              WHERE beli_brg.kd_toko='$kd_toko' AND beli_brg.no_fak='$no_fak' AND beli_brg.tgl_fak='$tgl_fak' AND mas_brg.nm_brg like '$kd_brg' AND INSTR(beli_brg.ket,'MUTASI')=0 AND INSTR(beli_brg.ket,'RETUR')=0");  
        }else{  
          $sql =mysqli_query($connect, "SELECT beli_brg.ket,beli_brg.tgl_fak,beli_brg.no_urut,beli_brg.kd_brg,beli_brg.jml_brg,beli_brg.kd_bar,beli_brg.kd_toko,beli_brg.no_fak,beli_brg.tgl_fak,beli_brg.kd_sup,beli_brg.kd_sat,beli_brg.hrg_beli,beli_brg.disc1,beli_brg.disc2,kemas.nm_sat1,kemas.nm_sat2,supplier.nm_sup,mas_brg.kd_kem1,mas_brg.jum_kem1,mas_brg.nm_brg,mas_brg.hrg_jum1,mas_brg.kd_kem2,mas_brg.jum_kem2,mas_brg.hrg_jum2,mas_brg.kd_kem3,mas_brg.jum_kem3,mas_brg.hrg_jum3,beli_brg.id_bag,bag_brg.nm_bag
              ...
              LEFT JOIN mas_brg ON beli_brg.kd_brg=mas_brg.kd_brg
              LEFT JOIN bag_brg ON beli_brg.id_bag=bag_brg.no_urut 
              WHERE beli_brg.kd_toko='$kd_toko' AND beli_brg.no_fak='$no_fak' AND beli_brg.tgl_fak='$tgl_fak' AND INSTR(beli_brg.ket,'MUTASI')=0 AND INSTR(beli_brg.ket,'RETUR')=0
               ORDER BY mas_brg.nm_brg ASC LIMIT $limit_start, $limit");
          $sql2 = mysqli_query($connect, "SELECT COUNT(*) AS jumlah FROM beli_brg WHERE kd_toko='$kd_toko' AND no_fak='$no_fak' AND tgl_fak='$tgl_fak' AND INSTR(beli_brg.ket,'MUTASI')=0 AND INSTR(beli_brg.ket,'RETUR')=0");   
        }
