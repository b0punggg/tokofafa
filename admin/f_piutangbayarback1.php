  ...
  <body >
    ...
    <div class="w3-container w3-card" style="background: linear-gradient(165deg, magenta 0%, yellow 36%, white 80%);position: sticky;top:43px;margin-top: -7px;z-index: 1;padding: 3px"><h5><i class='fa fa-cart-arrow-down'></i> &nbsp;TRANSAKSI &nbsp;<i class='fa fa-angle-double-right'></i>&nbsp;<span style="font-size: 18px">Bayar Piutang Pelanggan</span><span class="w3-right" style="font-size: 16px"><i class="fa fa-calendar-check-o"></i>&nbsp;<?=gantitgl($_SESSION['tgl_set'])?></span></h5> 
      ...
      <form id="form-input" class="w3-row" action="f_piutangbayar_act.php" method="post" style="padding-right: 10px;padding-left: 10px;border-style: ridge;border-color: white;background: linear-gradient(565deg, #FAFAD2 30%, white 100%);margin-top: 0">
        ...
        <div class="row">
          <div class="col">
            <button type="button" onclick="kosongkan()" style="width: 100%;height:30px;margin-top: 0px;margin-bottom: 0px;border-radius: 4px;font-size: 10pt;" class="w3-margin-bottom w3-card-2 btn-warning"><i class="fa fa-undo">&nbsp;&nbsp;</i><b>R E S E T</b></button>
          </div>
          <div class="col">
            <button type="submit" style="width: 100%;height:30px;margin-top: 0px;margin-bottom: 0px;border-radius: 4px;font-size: 10pt;" class="w3-margin-bottom w3-card-2 btn-primary"><i class="fa fa-save">&nbsp;&nbsp;</i><b>S I M P A N</b></button>
          </div>
          <div class="col">
          ...
          <div class="col">
            <a id="linkcetak" type="button" target="_blank" style="width: 100%;height:30px;margin-top: 0px;margin-bottom: 0px;border-radius: 4px;font-size: 10pt; text-align: center" class="w3-margin-bottom w3-card-2 btn btn-success w3-text-white"><i class="fa fa-save">&nbsp;&nbsp;</i><b>CETAK STRUK</b></a>
          </div>
          <div class="col">
            <button id="linkkirim" type="button" style="width: 100%;height:30px;margin-top: 0px;margin-bottom: 0px;border-radius: 4px;font-size: 10pt; text-align: center" class="w3-margin-bottom w3-card-2 btn btn-danger w3-text-white" onclick="
            if(document.getElementById('no_fakjual').value !=''){kirimres(document.getElementById('no_fakjual').value);}
            "><i class="fa fa-save">&nbsp;&nbsp;</i><b>KIRIM DATA KE RESELLER</b></button>
          </div>
        </div>            
      </form>  
