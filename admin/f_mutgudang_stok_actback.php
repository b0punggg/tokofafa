...
$cek_it=mysqli_query($connect,"SELECT beli_brg.kd_brg,beli_brg.no_urut,beli_brg.no_fak,beli_brg.kd_bar,beli_brg.kd_sup,beli_brg.stok_jual,beli_brg.hrg_beli,beli_brg.disc1,beli_brg.disc2,beli_brg.kd_sat,beli_brg.ket,beli_brg.ket_mut,beli_brg.ppn,mas_brg.nm_brg FROM beli_brg 
...
if($qty_brg>0){
  if ($ketawal>0){ // jika yang diambil dari pembelian barang
    ...
    $d=mysqli_query($connect,"INSERT INTO beli_brg VALUES('','$tgl_fak','$no_fak','$kd_brg','$kd_bar','$kd_tokotuj','$kd_sup','$kd_satawal','$hrg_beli','$disc1','$disc2','$jml_brg','$stok_jual','$ket1','','','$ketmut','$ppn','$id_bag')");   
